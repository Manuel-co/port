      ...
      <div className="container max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div className="md:sticky md:top-28">
            ...
            <div className="flex items-center gap-3 px-5 py-3 bg-[#FCD34D] border-4 border-black rounded-2xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] w-fit">
              ...
              <div key={exp.company}
                ...
                <div className="flex items-center justify-between px-6 py-5 border-b-4 border-black">
                  <div className="flex items-center gap-3">
                    <span className={`w-10 h-10 ${exp.color} border-2 border-black rounded-xl flex items-center justify-center flex-shrink-0 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]`}>
                  ...
                  <ul className="space-y-2">
                    {exp.bullets.map((b, j) => (
                      <li key={j} className="flex items-start gap-3 text-sm text-gray-600">
                        <span className={`w-2 h-2 ${exp.color} border-2 border-black rounded-full flex-shrink-0 mt-1.5`} />
                        {b}
                      </li>
                    ))}
                  </ul>
