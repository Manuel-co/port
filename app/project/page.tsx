            ...
            <AnimatePresence>
              {filtered.map((project, index) => (
                <motion.div key={project.slug}
                  ...
                  className="h-full">
                  <Link href={`/project/${project.slug}`} className="h-full flex flex-col bg-white border-4 border-black rounded-3xl overflow-hidden hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
                    {/* Image */}
                    ...
                    <div className="flex flex-col flex-1 p-6">
                      <h2 className="text-base font-bold text-black mb-2 leading-snug line-clamp-2 min-h-[2.5rem] hover:text-[#6366F1] transition-colors">
                        {project.title}
                      </h2>
